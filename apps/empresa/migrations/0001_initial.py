# Generated by Django 5.1.5 on 2025-05-24 19:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notificar_a', models.CharField(choices=[('todos', 'Todos los usuarios'), ('superuser', 'Solo el Administrador Principal')], default='todos', max_length=10, verbose_name='Enviar notificaciones a')),
                ('activar_notif_stock', models.BooleanField(default=False, verbose_name='Activar notificación por stock de productos')),
                ('stock_minimo_general', models.PositiveIntegerField(blank=True, null=True, verbose_name='Stock mínimo general')),
                ('stock_maximo_general', models.PositiveIntegerField(blank=True, null=True, verbose_name='Stock máximo general')),
                ('activar_notif_por_vencer', models.BooleanField(default=False, verbose_name='Activar notificación por vencer de productos')),
                ('dias_por_vencer_general', models.PositiveIntegerField(blank=True, null=True, verbose_name='Días antes de vencer (general)')),
